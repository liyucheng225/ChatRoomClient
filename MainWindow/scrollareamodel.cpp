...
//    scrollArea->setGeometry(40,70,290,400);
    this->setStyleSheet("QScrollArea{border: 0px solid;border-right-width: 1px;border-right-color: #dcdbdc;background-color: rgb(255,255,255);}"
                              ...
                              "QScrollBar:horizontal {border: none;background: #f5f5f7;width: 10px;margin: 0px 0 0px 0;}");
    this->setAttribute(Qt::WA_StyledBackground,true);

    this->setContentsMargins(0,0,0,0);
    this->setSizePolicy(QSizePolicy::Expanding,QSizePolicy::Expanding);
    qDebug() << "scrollArea size:"<< this->size();
